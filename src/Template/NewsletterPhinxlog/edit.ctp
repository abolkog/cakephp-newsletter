...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $newsletterPhinxlog->version],
                ['confirm' => __('Are you sure you want to delete # {0}?', $newsletterPhinxlog->version)]
            )
        ?></li>
...
<div class="newsletterPhinxlog form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Newsletter Phinxlog') ?></legend>
        <?php
